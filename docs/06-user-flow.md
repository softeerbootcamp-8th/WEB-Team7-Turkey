...
CORE 위키는 그 주제의 디스커션·이슈·부하테스트·스터디로 뻗는 링크 허브입니다(4번 참고).
...
> **콜 받기 = 수락 = 배차**는 같은 행위라 노드 하나로 합쳤습니다(사람 확인, 2026-08-13).
> 라이더 홈(`/rider`)의 "퀵 시작하기"(UNAVAILABLE→AVAILABLE)는 콜 목록 진입과 붙어 있어
> 별도 노드로 두지 않았습니다.
