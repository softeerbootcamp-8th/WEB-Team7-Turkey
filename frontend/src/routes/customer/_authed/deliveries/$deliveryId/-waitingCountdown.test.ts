...
describe('formatWaitingCountdown', () => {
  ...
  it('파싱 불가한 값은 만료로 오판하지 않고 전체 시간을 보여 준다', () => {
    ...
    expect(formatWaitingCountdown('not-a-date', REQUESTED_AT_MS)).toBe('5:00')
  })
})
