...
export type CustomerSignupFieldErrors = Partial<Record<keyof CustomerSignupFields, string>>

export interface CustomerSignupValidationContext {
  checkedLoginId: string | null
  phoneVerificationToken: string | null
  verifiedPhoneNumber: string | null
}

export interface CustomerSignupRequestError {
...
export function validateCustomerSignup(
  fields: CustomerSignupFields,
  context: CustomerSignupValidationContext,
): CustomerSignupFieldErrors {
...
export function classifyCustomerSignupError(error: unknown): CustomerSignupRequestError {
