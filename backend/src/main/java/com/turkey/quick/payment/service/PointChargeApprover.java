...
public class PointChargeApprover {
     ...
     *
     * <p><b>단 취소에 진 경우는 다르다</b>(#34): 상태가 CANCELED 라 이 메서드가 아무것도 하지 않는데,
     * 승인 식별자는 어디에도 기록된 적이 없다. 실 PG 라면 추적 불가 건이 된다 — 상세는
     * {@link CustomerPaymentService#cancelPointCharge} 주석.
     *
